    ...
    public static class World
    {
        ...
        public static void PopulateQuests()
        {
            Quest clearAlchemistGarden =
                new Quest(
                    QUEST_ID_CLEAR_ALCHEMIST_GARDEN, "Clear the alchemist's garden",
            ...
            Quest clearFarmersField =
                new Quest(
                    QUEST_ID_CLEAR_FARMERS_FIELD, "Clear the farmer's field",
                    "Kill snakes in teh farmer's field and bring back 3 snake fangs." +
        ...
        private static void PopulateLocations()
        {
            ...
            //Add the locations to teh static list
            Locations.Add(home);
